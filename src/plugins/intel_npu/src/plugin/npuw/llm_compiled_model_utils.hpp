...
std::shared_ptr<ov::Model> prepare_whisper_prefill_model(const std::shared_ptr<ov::Model>& model,
                                                         const uint32_t& max_prompt_size,
                                                         const uint32_t& lhs_seq_size);

std::shared_ptr<ov::Model> prepare_whisper_kvcache_model(const std::shared_ptr<ov::Model>& model);
